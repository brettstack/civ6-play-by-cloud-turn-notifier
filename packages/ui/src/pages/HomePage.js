...
function HomePage() {
  ...
  return <Container className={classes.root}>
    <div className={classes.inner}>
      ...
      <p><strong>Civilization 6 Play By Cloud</strong> is a new game mode that that lets you play <a href="https://civilization.com/" target="_blank" rel="noopener noreferrer" >Civ 6</a> with friends without needing to be online at the same time. Simply take your turn when it suits you and the game state is saved to the cloud, ready for the next player. Use this service to send messages to your Discord channel to notify players of a new turn.</p>
      ...
      <p>This service makes it easy to configure the <strong>Civ 6 Webhook</strong> to receive notifications to your Discord channel (additional notification methods coming soon).</p>
      ...
      <p>Steam notifications only let you know when it's <em>your</em> turn, whereas Discord notifications let <em>everyone</em> know whose turn it is.</p>

      <h2>I'm not getting notifications after setting this up</h2>
      <p>Notifications usually only works for new games created <strong>after</strong> setting the Webhook setting, however, there have been people who say it worked for existing games after several turns. You can also save your game and create a new Play By Cloud game based on the save file, though it can be quite tricky ensuring all players get their original Civ leader (you need to have players join in the order of their turns).</p>
